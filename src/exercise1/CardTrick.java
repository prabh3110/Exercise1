 ...
 * 
 * @author Prabal Manchanda Feb 2023 
 */
import java.util.*;
public class CardTrick {
   ...
   for(int i =0;i<hand.length;i++) {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Prabal, but you can call me prabh");
        System.out.println();
        
        System.out.println("My career ambitions:Software programer");
